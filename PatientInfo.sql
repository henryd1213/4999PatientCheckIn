...
CREATE TABLE IF NOT EXISTS `PatientInfo`.`Form_Questions` (
  ...
  `Radioone` VARCHAR(45) NULL,
  `Radiotwo` VARCHAR(45) NULL,
  `Radiothree` VARCHAR(45) BINARY NULL,
  `Radiofour` VARCHAR(45) NULL,
  `Radiofive` VARCHAR(45) NULL,
  `RadioSix` VARCHAR(45) NULL,
  PRIMARY KEY (`ID`, `Form_List_ID`),
...
VALUES 
(0,'Henry','Dare','exampleemail@domain.com','12/13/1999','nurseUser1','test','Nurse','123-456-7890','Male','22','N', '1'),
(0,'Sam','Dillon','exampleemail2@domain.com','12/13/1999','doctorUser1','test','Doctor','246-810-1214','Male','22','N', '1'),
(0,'Jared','Ormond','exampleemail3@domain.com','12/13/1999','adminUser1','test','Admin','135-791-1315','Male','22','N', '1');
